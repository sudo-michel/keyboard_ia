...
with open('layouts_claviers_2.csv', mode='w', newline='') as csvfile:
    ...
    for gen in range(generations):
        ...
        # Afficher le meilleur layout de cette génération dans la console
        print(f"Meilleur layout de la génération {gen + 1}: {current_best_layout}")
